...
class QuotationScope implements Scope
{
    ...
    public function apply(Builder $builder, Model $model)
    {
        ...
        $column_is_converted_list = $model->getQualifiedPublishedColumnConvertedList();
        $column_is_quotation_invoice_list = $model->getQualifiedPublishedColumnQuotationInvoiceList();
        $column_is_draft_quotation = $model->getQualifiedPublishedColumnDraftQuotations();
        $builder->where([
            [$column, '=', 0],
            [$column_is_converted_list, '=', 0],
            [$column_is_quotation_invoice_list, '=', 0],
//            [$column_is_draft_quotation, '!=', 'Draft Quotation']
        ]);
