...
<div style="position:absolute;left:186.05px;top:203.44px" class="cls_002"><span class="cls_002">SERVICE PROPOSAL</span></div>
<div style="position:absolute;left:218.88px;top:271.92px" class="cls_003"><span class="cls_003">RE: {{ is_null($quotation->company)?"":$quotation->company->name }}</span></div>
...
<div style="position:absolute;left:144.00px;top:378.72px" class="cls_005"><span class="cls_005">{{ is_null($quotation->salesPerson)?"":$quotation->salesPerson->full_name }}</span></div>
<div style="position:absolute;left:414.96px;top:378.96px" class="cls_005"><span class="cls_005">{{ is_null($quotation->customer)?"":$quotation->customer->user->full_name }}</span></div>
...
<div style="position:absolute;left:26.16px;top:763.60px" class="cls_007"><span class="cls_007">2 J u rong East Street 21, #02-168 IMM Building, Singapore 609601</span></div>
