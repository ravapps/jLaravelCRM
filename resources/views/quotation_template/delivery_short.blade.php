...
<div style="position:absolute;left:33.74px;top:150.48px" class="cls_004"><span class="cls_004">Name: </span><span class="cls_005">{{ is_null($saleorder->company)?"":$saleorder->company->name }}</span></div>
<div style="position:absolute;left:308.16px;top:150.24px" class="cls_004"><span class="cls_004"> </span><span class="cls_005"></span></div>
<div style="position:absolute;left:370.32px;top:150.24px" class="cls_004"><span class="cls_004">  </span><span class="cls_005"></span></div>
<div style="position:absolute;left:308.40px;top:160.80px" class="cls_004"><span class="cls_004">Delivery Date</span></div>
<div style="position:absolute;left:370.32px;top:160.56px" class="cls_004"><span class="cls_004">:  </span><span class="cls_005">{{ $delorder->delivery_date }}</span></div>
<div style="position:absolute;left:34.56px;top:171.36px" class="cls_004"><span class="cls_004">Address</span></div>
<div style="position:absolute;left:308.40px;top:171.36px" class="cls_004"><span class="cls_004">Order By </span></div>
<div style="position:absolute;left:372.24px;top:171.12px" class="cls_004"><span class="cls_004"> </span><span class="cls_005"> {{$saleorder->customer->first_name}}  {{$saleorder->customer->last_name}}</span></div>
...
<div style="position:absolute;left:308.16px;top:181.68px" class="cls_004"><span class="cls_004">Contact Number</span></div>
<div style="position:absolute;left:371.76px;top:181.68px" class="cls_004"><span class="cls_004">: </span><span class="cls_005">{{$saleorder->customer->phone_number}}</span></div>
...
<div style="position:absolute;left:32.40px;top:226.08px" class="cls_004"><span class="cls_004"></span></div>
<div style="position:absolute;left:38.16px;top:249.84px" class="cls_004"><span class="cls_004">Remarks</span></div>
<div style="position:absolute;left:232.00px;top:249.60px" class="cls_004"><span class="cls_004">Product Details</span></div>

<div style="position:absolute;left:444.72px;top:249.84px" class="cls_004"><span class="cls_004">Qty</span></div>
<div style="position:absolute;left:501.60px;top:249.84px" class="cls_004"><span class="cls_004">Unit Price</span></div>
...
<div style="position:absolute;left:45.12px;top:{{$topunit}}px" class="cls_005"><span class="cls_005"></span></div>

<div style="position:absolute;left:112.64px;top:{{$topunit}}px" class="cls_005"><span class="cls_005">{{$variants->OrderProductsDetails->product_name}}</span></div>
<div style="position:absolute;left:450.48px;top:{{$topunit}}px" class="cls_005"><span class="cls_005">{{$variants->quantity}}</span></div>
<div style="position:absolute;left:511.92px;top:{{$topunit}}px" class="cls_005"><span class="cls_005">@money($variants->price)</span></div>
<div style="position:absolute;left:112.40px;top:{{$topunit+11}}px" class="cls_005"><span class="cls_005">{{$variants->OrderProductsDetails->description}}</span></div>
<div style="position:absolute;left:112.64px;top:{{$topunit+22}}px" class="cls_005"><span class="cls_005">{{$variants->OrderProductsDetails->description_for_quotations}}</span></div>
@php $topunit = $topunit+22+20; @endphp
@endforeach
@endif

<div style="position:absolute;left:33.60px;top:559.44px" class="cls_004"><span class="cls_004">Approved By</span></div>
<div style="position:absolute;left:34.08px;top:579.60px" class="cls_015"><span class="cls_015"></span></div>
...
<div style="position:absolute;left:36.24px;top:661.20px" class="cls_004"><span class="cls_004">Received By</span></div>
<div style="position:absolute;left:309.12px;top:661.20px" class="cls_004"><span class="cls_004">Delivered By</span></div>
...
<div style="position:absolute;left:35.76px;top:727.20px" class="cls_005"><span class="cls_005"></span></div>
<div style="position:absolute;left:309.36px;top:727.44px" class="cls_005"><span class="cls_005"></span></div>
