  ...
  <?php echo " - ".\App\Models\Customer::find($saleorder->customer->id)->contactSitelocation->unitto ?>
          ...
          <div class="col-xs-12 col-sm-6">
              <div class="form-group required {{ $errors->has('date') ? 'has-error' : '' }}">
                  ...
                  <div class="controls">
                      {!! Form::text('delivery_date', isset($delivery) ? $delivery->delivery_date : null, ['class' => 'form-control date', 'id' =>'delivery_date']) !!}
                ...
                <div class="col-xs-12 col-sm-6">
                    <div class="form-group required {{ $errors->has('total') ? 'has-error' : '' }}">
                        ...
                        <div class="controls">
                            ...
                            <span class="help-block">{{ $errors->first('approved_by', ':message') }}</span>
                        </div>
                    </div>
                </div>
                <div class="col-xs-12 col-sm-6">
