                                ...
                                <li>
                                    <div class="checkbox">
                                        <label for="column1" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="1" id="column1"> {{ trans('qtemplate.quotation_template') }}
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div class="checkbox">
                                        <label for="column2" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="2" id="column2"> {{ trans('qtemplate.total') }}
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div class="checkbox">
                                        <label for="column3" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="3" id="column3" checked> {{ trans('qtemplate.tax_amount') }}
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div class="checkbox">
                                        <label for="column4" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="4" id="column4"> {{ trans('qtemplate.grand_total') }}
                                        </label>
                                    </div>
                                </li>
                ...
                <table id="data" class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>{{ trans('qtemplate.total') }}</th>
                            <th>{{ trans('qtemplate.tax_amount') }}</th>
                            <th>{{ trans('qtemplate.grand_total') }}</th>
