                                ...
                                <li>
                                    <div class="checkbox">
                                        <label for="column5" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="5" id="column5"> {{ trans('sales_order.date') }}
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div class="checkbox">
                                        <label for="column6" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="6" id="column6"> {{ trans('sales_order.exp_date') }}
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div class="checkbox">
                                        <label for="column7" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="7" id="column7"> {{ trans('sales_order.total') }}
                                        </label>
                                    </div>
                                </li>
                                <li>
                                    <div class="checkbox">
                                        <label for="column8" class="toggle-vis">
                                            <input type="checkbox" class="icheckblue" data-column="8" id="column8"> {{ trans('sales_order.payment_term') }}
                                        </label>
                                    </div>
                                </li>
                                <li>
            ...
            <div class="table-responsive">
                <table id="data" class="table  table-bordered">
                    ...
                    <tr>
                        ...
                        <th class="noExport">{{ trans('sales_order.expired') }}</th>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function () {
                oTable = $('#data').DataTable({
                    ...
                    "ajax": "{{ url($type.'/draft_salesorder_list') }}" + ((typeof $('#data').attr('data-id') != "undefined") ? "/" + $('#id').val() + "/" + $('#data').attr('data-id') : "/data"),
                    dom: 'Bfrtip',
                    pageLength: 15,
                    stateSave: true,
                    "columnDefs": [
