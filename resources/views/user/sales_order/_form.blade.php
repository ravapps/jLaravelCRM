        ...
        <div class="row">
          <div class="col-xs-12 col-sm-6">
              <div class="form-group {{ $errors->has('customer_id') ? 'has-error' : '' }}">
                  ...
                  <div class="controls">
                      {!! Form::select('company_id', $companies, (isset($saleorder->company_id)?$saleorder->company_id:null), ['id'=>'company_id','class' => 'form-control']) !!}   <a href="{{url('sales_order/createcompany')}}">{{ trans('company.create_company') }}</a>
